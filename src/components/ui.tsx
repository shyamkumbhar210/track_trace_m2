...
export function inferTone(value: string): Tone {
  if (["Active", "Approved", "APPROVED", "DELIVERED", "Success", "Verified", "In Circulation"].includes(value)) return "success";
  if (["Critical", "Frozen", "Recalled", "Voided", "DISPUTED", "REJECTED", "Rejected", "Expired", "Not Recognized"].includes(value)) return "destructive";
  if (["Warning", "Pending", "REQUESTED", "PENDING", "IN_TRANSIT", "Pending Activation", "Not Activated", "DRAFT"].includes(value)) return "warning";
  ...
  return (
    <div>
      ...
      <div className="mt-3 flex items-center justify-end gap-2">
        ...
        <span className="mono px-2">Page {page} / {totalPages}</span>
